...
$(function () {
    ...
    $('.comment_list_con').delegate('a,input', 'click', function () {
        ...
        // var sHandler1 = $(this).attr('class');
        // console.log(sHandler1);

        if ($(this).hasClass('comment_reply')) {
            $(this).next().toggle();
        }

        if ($(this).hasClass('reply_cancel')) {
            $(this).parent().hide();
        }

        if ($(this).hasClass('comment_up')) {
            var $this = $(this);
    ...
    $(".focus").click(function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.errno === "0") {
                    // 关注成功
                    var $follow = $(".follows b");
                    console.log(parseInt($follow.html()));
